...
function Button(text, func, func_param, width, height)
    return {
        ...
        draw = function(self, button_x, button_y, text_x, text_y)
            ...
            end -- this will make the text take x and y coordenadas from inside the button and not the entire screen of the game

            love.graphics.setColor(88/255, 181/255, 252/255)
            love.graphics.rectangle("fill", self.button_x, self.button_y, self.width, self.height)

            love.graphics.setColor(1/255, 37/255, 64/255)
            love.graphics.print(self.text, self.text_x, self.text_y)

            love.graphics.setColor(45/255, 130/255, 194/255)
        end
    }
