--"C:\Program Files\LOVE\love.exe" "D:Harvard\Game3"
...
function love.mousepressed(x, y, button, istouch, presses) --istouch is for touch screens
...
function love.load()
    love.graphics.setBackgroundColor(116/255, 179/255, 132/255)
...
function love.draw()
    ...
    elseif game.state["ended"] then
        ...
        buttons.ended_state.replay_game:draw(love.graphics.getWidth() / 2.15, love.graphics.getHeight() / 1.8, 10, 10)
        buttons.ended_state.menu:draw(love.graphics.getWidth() / 2.15, love.graphics.getHeight() / 1.54, 17, 10)
        buttons.ended_state.exit_game:draw(love.graphics.getWidth() / 2.15, love.graphics.getHeight() / 1.33, 22, 10)

        love.graphics.printf(math.floor(game.points), fonts.massive.font, 20, love.graphics.getHeight() / 2 - fonts.massive.size, love.graphics.getWidth(), "center")
    end
